module ElasticTranscoder
  ...
  class Jobs
    ...
    def create_job input_key, output_key, pipeline_id, preset_id, thumbnail_pattern, segment_duration
      action = "jobs"
      creation_params = '{"Input":{"Key":"'+input_key+'","FrameRate":"auto","Resolution":"auto","AspectRatio":"auto","Interlaced":"auto","Container":"auto"}, "Output":{"Key":"'+output_key+'","ThumbnailPattern":"'+thumbnail_pattern+'","Rotate":"auto","PresetId":"'+preset_id+'","SegmentDuration":"'+segment_duration+'"} ,"PipelineId":"'+pipeline_id+'"}'
    ...
    def create_jobs input_key, output, pipeline_id, playlist
      action = "jobs"
    ...
    def create_jobs_with_playlist input_key, output, pipeline_id, playlist
      action = "jobs"
      creation_params = '{"Input":{"Key":"'+input_key+'","FrameRate":"auto","Resolution":"auto","AspectRatio":"auto","Interlaced":"auto","Container":"auto"},"Outputs":'+output+',"Playlists":['+playlist+'],"PipelineId":"'+pipeline_id+'"}'
